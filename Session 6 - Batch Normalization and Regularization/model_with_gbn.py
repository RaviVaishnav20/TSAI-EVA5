...
class Net(nn.Module):
    def __init__(self):
        ...
        self.trans1 = nn.Sequential(
            ...
            # output_image = 26, RF=3
            nn.ReLU(),
            GhostBatchNorm(num_features=8, num_splits=n_splits, weight=False),
            nn.Dropout2d(dropout_value)
        )
        ...
        self.convblock2 = nn.Sequential(
            ...
            nn.ReLU(),
            GhostBatchNorm(num_features=10, num_splits=n_splits, weight=False),
            nn.Dropout2d(dropout_value)
        )
        ...
        self.convblock3 = nn.Sequential(
            ...
            nn.ReLU(),
            GhostBatchNorm(num_features=16, num_splits=n_splits, weight=False),
            nn.Dropout2d(dropout_value)
        )
