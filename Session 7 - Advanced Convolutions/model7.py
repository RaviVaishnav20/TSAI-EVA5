...
class Net(nn.Module):
    def __init__(self, dropout_value=0.1):
        ...
        self.convblock1 = nn.Sequential(
            nn.Conv2d(in_channels=self.num_of_channels, out_channels=64, kernel_size=(3, 3), padding=1, bias=False),
            nn.ReLU(),
            GhostBatchNorm(num_features=64, num_splits=n_splits, weight=False),
        ...
        self.t = nn.Sequential(
            ...
            nn.ReLU(),
            GhostBatchNorm(num_features=32, num_splits=n_splits, weight=False),
            nn.Dropout(self.dropout_value)
        ...
        self.convblock3 = nn.Sequential(
            ...
            nn.ReLU(),
            GhostBatchNorm(num_features=128, num_splits=n_splits, weight=False),
            nn.Dropout(self.dropout_value)
        ...
        self.convblock6 = SeparableConv2d(in_channels=64, out_channels=128, kernel_size=1, stride=1, padding=1,
        ...
        self.convblock12 = nn.Sequential(
            ...
            nn.ReLU(),
            GhostBatchNorm(num_features=256, num_splits=n_splits, weight=False),
            nn.Dropout(self.dropout_value)
